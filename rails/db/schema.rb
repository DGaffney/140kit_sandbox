...
ActiveRecord::Schema.define(:version => 0) do
  ...
  create_table "coordinates", :force => true do |t|
    ...
    t.string  "original_model", :limit => 50
  end
  ...
  create_table "curations", :force => true do |t|
    ...
    t.datetime "created_at",                   :default => '2012-02-24 15:24:13'
    t.datetime "updated_at",                   :default => '2012-02-24 15:24:13'
  ...
  create_table "instances", :force => true do |t|
    t.string  "instance_id",   :limit => 40
    t.string  "hostname",      :limit => 50, :default => "[\"vpn07.oii.ox.ac.uk\\n\"]"
    t.integer "pid",                         :default => 12897
