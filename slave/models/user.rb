class User
  ...
  property :profile_background_tile, Boolean, :index => [:profile_background_tile_dataset, :profile_background_tile]
  property :profile_use_background_image, Boolean, :index => [:profile_use_background_image_dataset, :profile_use_background_image]
  property :show_all_inline_media, Boolean, :index => [:show_all_inline_media_dataset, :show_all_inline_media]
  property :is_translator, Boolean, :index => [:is_translator_dataset, :is_translator]
  property :notifications, Boolean, :index => [:notifications_dataset, :notifications]
  property :geo_enabled, Boolean, :index => [:geo_enabled_dataset, :geo_enabled]
  property :verified, Boolean, :index => [:verified_dataset, :verified]
  property :following, Boolean, :index => [:following_dataset, :following]
  property :statuses_count, Integer, :index => [:statuses_count_dataset, :statuses_count]
  property :contributors_enabled, Boolean, :index => [:contributors_enabled_dataset, :contributors_enabled]
  property :lang, String, :index => [:lang_dataset, :lang]
  property :listed_count, Integer, :index => [:listed_count_dataset, :listed_count]
  property :follow_request_sent, Boolean, :index => [:follow_request_sent_dataset, :follow_request_sent]
