class GraphPoint
  ...
  property :id, Serial
  property :label, String, :index => [:label_value_graph_id, :label_value, :label_curation_id, :label_graph_id_curation_id]
  property :value, String, :index => [:label_value_graph_id, :label_value]
