class Entity
  ...
  property :twitter_id, Integer, :unique_index => [:unique_entity], :index => [:twitter_id, :dataset_id_twitter_id, :twitter_id_kind, :twitter_id_name, :twitter_id_value, :dataset_id_twitter_id_kind, :twitter_id_kind_name, :twitter_id_kind_value, :twitter_id_kind_name_value, :dataset_id_twitter_id_kind_name, :dataset_id_twitter_id_kind_value, :dataset_id_twitter_id_kind_name_value], :min => 0, :max => 2**64-1
  ...
  property :name, String, :unique_index => [:unique_entity], :index => [:name, :dataset_id_name, :twitter_id_name, :kind_name, :name_value, :dataset_id_kind_name, :twitter_id_kind_name, :twitter_id_kind_name_value, :dataset_id_kind_name_value, :dataset_id_twitter_id_kind_name, :dataset_id_twitter_id_kind_name_value]
