class AdvancedHistogram < AnalysisMetadata
    ...
    while !records.empty?
      sequential_tweet_graphs.each do |sequential_tweet_graph|
        ...
        when "hashtag_count|retweet_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.hashtag_count, :value => record.retweet_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "link_count|retweet_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.links_count, :value => record.retweet_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "mention_count|retweet_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.mentions_count, :value => record.retweet_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "entity_count|retweet_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.all_entities_count, :value => record.retweet_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "source_retweet_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.source, :value => record.retweet_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "source_link_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.source, :value => record.links_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "source_mention_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.source, :value => record.mentions_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "source_entity_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.source, :value => record.all_entities_count, :graph_id => sequential_tweet_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        end
      end
      offset+=limit
      records = DataMapper.repository.adapter.select(full_entity_matched_query.call(conditional, limit, offset))
  ...
  def self.generate_tweet_avg_sum_graphs(curation, additional_query={}, analytic=self, title_suffix="")
    ...
    while !records.empty?
      GraphPoint.save_all(records.collect{|record| {:label => record.created_at, :value => record.tweet_count, :graph_id => tweets_per_minute.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
      GraphPoint.save_all(records.collect{|record| {:label => record.created_at, :value => record.retweet_count, :graph_id => retweets_per_minute.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
      offset += limit
      records = DataMapper.repository.adapter.select(time_based_tweet_query.call(limit, offset))
    end
  end
    ...
    while !records.empty?
      sequential_user_graphs.each do |sequential_user_graph|
        ...
        when "followers_count|friends_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.followers_count, :value => record.friends_count, :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "followers_count|statuses_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.followers_count, :value => record.statuses_count, :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "friends_count|statuses_count"
          GraphPoint.save_all(records.collect{|record| {:label => record.friends_count, :value => record.statuses_count, :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "followers_|day"
          GraphPoint.save_all(records.collect{|record| {:label => record.twitter_id, :value => record.followers_count.to_f/((Time.now-record.created_at).to_f/86400.0), :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "friends_|day"
          GraphPoint.save_all(records.collect{|record| {:label => record.twitter_id, :value => record.friends_count.to_f/((Time.now-record.created_at).to_f/86400.0), :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "statuses_|day"
          GraphPoint.save_all(records.collect{|record| {:label => record.twitter_id, :value => record.statuses_count.to_f/((Time.now-record.created_at).to_f/86400.0), :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "avg_followers_per_day|avg_friends_per_day"
          GraphPoint.save_all(records.collect{|record| {:label => record.followers_count.to_f/((Time.now-record.created_at).to_f/86400.0), :value => record.friends_count.to_f/((Time.now-record.created_at).to_f/86400.0), :graph_id => sequential_user_graph.id, :analysis_metadata_id =>  @analysis_metadata.id, :curation_id => curation.id}})
        when "avg_followers_per_day|avg_statuses_per_day"
          GraphPoint.save_all(records.collect{|record| {:label => record.followers_count.to_f/((Time.now-record.created_at)/86400.0), :value => record.statuses_count.to_f/((Time.now-record.created_at).to_f/86400.0), :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "avg_friends_per_day|avg_statuses_per_day"
          GraphPoint.save_all(records.collect{|record| {:label => record.friends_count.to_f/((Time.now-record.created_at).to_f/86400.0), :value => record.statuses_count.to_f/((Time.now-record.created_at).to_f/86400.0), :graph_id => sequential_user_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        end
      end
      offset += limit
      records = User.all(conditional.merge({:limit => limit, :offset => offset}))
    ...
    while !records.empty?
      user_avg_sum_graphs.each do |user_avg_sum_graph|
        ...
        when "location|avg_followers_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.location, :value => record.avg_followers_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "location|avg_friends_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.location, :value => record.avg_friends_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "location|avg_statuses_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.location, :value => record.avg_statuses_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "location|sum_followers_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.location, :value => record.sum_followers_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "location|sum_friends_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.location, :value => record.sum_followers_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "location|sum_statuses_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.location, :value => record.sum_statuses_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "avg_followers_counts|avg_friends_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.avg_followers_count, :value => record.avg_friends_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "avg_followers_counts|avg_statuses_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.avg_followers_count, :value => record.avg_statuses_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "avg_friends_counts|avg_statuses_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.avg_friends_count, :value => record.avg_statuses_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "sum_followers_counts|sum_friends_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.sum_followers_count, :value => record.sum_friends_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "sum_followers_counts|sum_statuses_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.sum_followers_count, :value => record.sum_statuses_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        when "sum_friends_counts|sum_statuses_counts"
          GraphPoint.save_all(records.collect{|record| {:label => record.sum_friends_count, :value => record.sum_statuses_count, :graph_id => user_avg_sum_graph.id, :analysis_metadata_id => @analysis_metadata.id, :curation_id => curation.id}})
        end
      end
      offset += limit
      records = DataMapper.repository.adapter.select(location_grouped_user_query.call(limit, offset))
